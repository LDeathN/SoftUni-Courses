...
class BaseVehicle(ABC):
    ...
    def __str__(self):
        if self.is_damaged:
            return f"{self.__brand} {self.__model} License plate: {self.__license_plate_number} Battery: {self.battery_level}% Status: Damaged"
        else:
            return f"{self.__brand} {self.__model} License plate: {self.__license_plate_number} Battery: {self.battery_level}% Status: OK"
